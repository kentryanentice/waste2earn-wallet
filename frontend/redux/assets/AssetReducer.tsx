...
const initialState: AssetState = {
  ...
  utilData: {
    ...
    // icr2SystemAssets: ICRC2systemAssets
  },
  list: {
    assets: [],
  },
...
const assetSlice = createSlice({
  ...
  reducers: {
    ...
    // setICRC2SystemAssets(state, action: PayloadAction<Asset[]>) {
    //   state.utilData.icr2SystemAssets = [...ICRC2systemAssets, ...action.payload];
    // },
