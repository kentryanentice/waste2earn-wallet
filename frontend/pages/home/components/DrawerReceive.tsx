...
const DrawerReceive = () => {
  ...
  return (
    <Fragment>
      <div className="flex flex-col justify-start items-center w-full h-full gap-4 pt-[10%]">
        ...
        <div className="flex flex-row justify-start items-center p-2 border border-BorderColorLight dark:border-BorderColor bg-SecondaryColorLight dark:bg-SecondaryColor rounded">
